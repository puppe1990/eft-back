...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference("Phrase.count") do
      post phrases_url, params: { phrase: { category_id: @phrase.category_id, description: @phrase.description } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { category_id: @phrase.category_id, description: @phrase.description } }
